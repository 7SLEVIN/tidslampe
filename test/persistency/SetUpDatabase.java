...
public class SetUpDatabase {
	...
	public void setUp() throws Exception {
		 ...
		 this.db.getConn().execUpdate("create table if not exists activity (id integer primary key autoincrement, description string, expected_time float, start_time string, end_time string)");
