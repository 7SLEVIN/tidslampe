...
public class LoginController {
	...
	public long logout(){
		...
		System.out.println("You have logged out. We should implement something that tells you whether or not you have registered all the hours you've been online.");
